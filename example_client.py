...
async def test_mcp_tools():
    ...
    try:
        ...
        split_result = await client.call_tool(
            "split_text",
            {
        ...
        fuzzy_result = await client.call_tool(
            "fuzzy_delete",
            {
        ...
        similarity_result = await client.call_tool(
            "get_similarity",
            {"text1": "apple", "text2": "aple", "algorithm": "levenshtein"},
        )
    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            async with client.stream(
                "POST", "http://localhost:8000/text/split", json=payload
            ) as response:
